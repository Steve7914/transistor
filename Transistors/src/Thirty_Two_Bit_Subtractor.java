...
public class Thirty_Two_Bit_Subtractor {

	int[] bits1;
	int[] bits2;
	Eight_Bit_Subtractor first;
	Eight_Bit_Subtractor_Continuer second;
	Eight_Bit_Subtractor_Continuer third;
	Eight_Bit_Subtractor_Continuer fourth;
	...
	public Thirty_Two_Bit_Subtractor(boolean[] bits1, boolean[] bits2) {
		overflow = false;
		...
		first = new Eight_Bit_Subtractor(FirstEightBits1, FirstEightBits2);
		//
		...
		second = new Eight_Bit_Subtractor_Continuer(EightSixteenBits1, EightSixteenBits2, first.eighth.getBorrow());
		//
		...
		third = new Eight_Bit_Subtractor_Continuer(SixteenTwentyFourBits1, SixteenTwentyFourBits2, second.getBorrow());
		//
		...
		fourth = new Eight_Bit_Subtractor_Continuer(TwentyFourThirtyTwoBits1, TwentyFourThirtyTwoBits2, third.getBorrow());
		//
