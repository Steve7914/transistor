...
public class Eight_Bit_Subtractor_Continuer {
	int[] bits1;
	int[] bits2;
	FULL_SUBTRACTOR first;
	...
	boolean overflow;
	boolean[] result;
	public Eight_Bit_Subtractor_Continuer(boolean[] bits1, boolean[] bits2, boolean borrow) {
		overflow = false;
		first = new FULL_SUBTRACTOR(borrow, bits1[7], bits2[7]);
